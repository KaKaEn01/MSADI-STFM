...
class Experiment(object):
    ...
    def train_on_epoch(self, n_epoch, data_loader):
        ...
        return epg_loss.avg,epg_error.avg,epfrequency_loss.avg
    
    def train(self, train_dir, val_dir, patch_stride, batch_size,num_workers=0, epochs=50, resume=True):
        ...
        for epoch in range(start_epoch, epochs):
            ...
            train_g_loss, train_g_error,frequency_loss= self.train_on_epoch(epoch, train_loader)
            val_error = self.test_on_epoch(val_loader)
            csv_header = ['epoch', 'train_g_loss','frequency_loss','train_g_error','val_error']
            csv_values = [epoch, train_g_loss,frequency_loss,train_g_error, val_error]
    ...
    def test(self, test_dir, image_size, patch_size, num_workers=0):
        ...
        for inputs in test_loader:
            ...
            name=image_paths[image_index][-1].stem 
